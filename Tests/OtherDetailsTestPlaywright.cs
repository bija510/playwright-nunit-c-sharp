...
{
    /// <summary>
    /// Playwright-based Other Details tests
    /// </summary>
    [TestFixture]
    public class OtherDetailsTestPlaywright : PlaywrightBaseTest
    {
        ...
        [Test]
        [Category("Smoke")]
        public async Task VerifyInfoMenuPage()
        {
            ...
            test.Pass("Personal details verified successfully");
        }
    }
}
